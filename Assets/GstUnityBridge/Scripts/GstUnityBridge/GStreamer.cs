...
public class GStreamer
{
    ...
    public static void AddPluginsToPath()
    {
        ...
        Debug.Log("Inside Unity_Editor_64 \n");
        dllPath = Application.dataPath + "/Plugins/GStreamer/x86_64/bin";
        bridgeDLLPath = Application.dataPath + "/Plugins/GstUnityBridge/x86_64";
        var combinedPath = dllPath + Path.PathSeparator + bridgeDLLPath + Path.PathSeparator;
#endif

        Environment.SetEnvironmentVariable("PATH",
               currentPath + Path.PathSeparator + combinedPath,
               EnvironmentVariableTarget.Process);
