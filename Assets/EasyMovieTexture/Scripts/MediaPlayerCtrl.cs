...
public class MediaPlayerCtrl : MonoBehaviour
{
    ...
    public void setVideoDownloader()
    {
#if !UNITY_EDITOR && !UNITY_STANDALONE && !UNITY_WEBGL
#if UNITY_ANDROID
        Call_setVideoDownloader();
#endif
#endif
    ...
    private void Call_setVideoDownloader()
    {
        Debug.Log("EasyMovieTextureCsharp, Call_setVideoDownloader");
        GetJavaObject().Call("setVideoDownloader");
    }
